...
class TestSpecs(TestCase):
    ...
    def test_display_name(self):
        assert self.definition.display_name_zh_cn == "x"
        assert self.specification.display_name_zh_cn == "0"
    ...
    def test_full_specifications(self):
        ...
        assert self.plan.full_specifications == {"x": "0", "none": None}
