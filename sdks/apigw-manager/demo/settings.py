...
BK_API_GRANT_PERMISSIONS_APPS = env.list("BK_API_GRANT_PERMISSIONS_APPS", default=[])
BK_API_APPLY_PERMISSIONS_GATEWAYS = env.list("BK_API_APPLY_PERMISSIONS_GATEWAYS", default=[])
BK_APIGW_RESOURCE_DOCS_BASE_DIR = env.str("BK_APIGW_RESOURCE_DOCS_BASE_DIR", default="docs")
BK_APIGW_RESOURCE_DOCS_ARCHIVE_FILE = env.str("BK_APIGW_RESOURCE_DOCS_ARCHIVE_FILE", default="")

APIGW_JWT_PUBLIC_KEY_MANAGER_CLS = env.str(
    "APIGW_JWT_PUBLIC_KEY_MANAGER_CLS",
    default="apigw_manager.apigw.helper.PublicKeyManager",
)

# For Kubernetes
APIGW_JWT_PUBLIC_KEY_SECRET_NAMESPACE = env.str("APIGW_JWT_PUBLIC_KEY_SECRET_NAMESPACE", default="default")
APIGW_JWT_PUBLIC_KEY_SECRET_MAPPINGS = env.dict("APIGW_JWT_PUBLIC_KEY_SECRET_MAPPINGS", default={})
